...
class _AuthRemote implements AuthRemote {
  _AuthRemote(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://be.karlearn.site';
  }
  ...
  @override
  Future<ApiResponse<LoginResponse>> login(LoginRequest payload) async {
  ...
  @override
  Future<ApiResponse<UserResponse>> profile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
